...
// =>f
let sidebar_industrial_btn = document.querySelector("#industrial_sidebar_btn");
...
let sidebar_kitchen_btn_i = document.querySelector("#kitchen_sidebar_btn > i");
...
function_to_accord(sidebar_footwear_btn, footwear_box, sidebar_footwear_btn_i);
function_to_accord(sidebar_electric_btn, electric_box, sidebar_electric_btn_i);
