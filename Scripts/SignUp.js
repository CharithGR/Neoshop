...
class User{
    ...
    async SignUP(name,email,password,userType){
        ...
        if(!(check_if_user_exists(data,email))){
             response = await fetch(`https://shrouded-beyond-89498.herokuapp.com/SignUp`,{
            method: 'POST',
...
const passwordCheck=(p)=>{
    ...
    let a=["Length is between 8-18 Characters","Conatins Uppercase and Lowercase","Contains Number and Special Character"]
